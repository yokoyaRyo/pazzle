...
function CreateField(line, column, body) {
	...
	var rankNumber = CreateElement('div', 'rankNumber');
	var number = CreateTextNode(4);
	rankNumber.setAttribute('data-num', 4);
	AddElement(rankNumber, number);
	AddElement(gameElement, rankNumber);

	var saveButton = CreateButton('div', 'save', 'メニューに戻る', gameElement);
	saveButton.setAttribute('onclick', 'ReturnMenu()');
}

function Rank() {
//	document.getElementById('save').setAttribute('data-menu', menuElement);

	var menuElement = document.getElementById('menu');
	menuElement.setAttribute('style', 'display: none');

	var rankPage = CreateElement('div', 'rankPage');
	AddElement(document.body, rankPage);
	var saveButton = CreateButton('div', 'return', 'メニューに戻る', rankPage);
	saveButton.setAttribute('onclick', 'ReturnMenu2()');
	...
	$.ajax({
	    ...
	    success: function (data) {
	    	...
	    	var tableTag = CreateElement('table', 'rankTable');
	    	...
	    	AddElement(document.getElementById('rankPage'), tableTag);
...
//	block.setAttribute('style', 'font-weight: 700');
...
function ReturnMenu() {
	DeleteElement(document.body, document.getElementById('gameElement'));
...
function InsertRank() {
	...
	var num = document.getElementById('rankNumber').getAttribute('data-num');
...
function CalcRank() {
	var num = parseInt(document.getElementById('rankNumber').getAttribute('data-num'));
	DeleteElement(document.getElementById('gameElement'), document.getElementById('rankNumber'));
	DeleteElement(document.getElementById('gameElement'), document.getElementById('save'));


	var rankNumber = CreateElement('div', 'rankNumber');
	var number = CreateTextNode(num + 2);
	rankNumber.setAttribute('data-num', num + 2);
	AddElement(rankNumber, number);
	AddElement(gameElement, rankNumber);
